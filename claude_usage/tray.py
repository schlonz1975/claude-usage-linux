...
from .client import ClaudeClientError, read_usage
...
class UsageTray:
    ...
    def __init__(self) -> None:
        ...
        installed_icon = project_linux / "assets" / "claude-tray.png"
        development_icon = project_linux.parent / "Resources" / "claude-dark.png"
        ...
        self.indicator.set_icon_full(str(icon_path), "Claude usage")
        ...
        self._show_message("Connecting to Claude…")
    ...
    def _apply_snapshots(self, snapshots: list[LimitSnapshot]) -> bool:
        ...
        self.indicator.set_title(f"Claude: {lowest}% left")
    ...
    def _show_error(self, message: str) -> bool:
        ...
        self.indicator.set_title("Claude: usage unavailable")
        return GLib.SOURCE_REMOVE
    ...
    def _update_status_icon(self) -> None:
        ...
        self.indicator.set_icon_full(str(icon), "Claude usage: outer session, inner weekly")
