...
PlasmoidItem {
    ...
    readonly property string serviceName: "com.schlonz1975.ClaudeUsage"
    readonly property string servicePath: "/com/schlonz1975/ClaudeUsage"
    readonly property string serviceInterface: "com.schlonz1975.ClaudeUsage"
    ...
    readonly property string statusText: backend.properties && backend.properties.Error
        ? i18n("Usage unavailable")
        : remaining >= 0 ? i18n("%1% remaining", remaining) : i18n("Connecting…")

    Plasmoid.title: i18n("Claude Usage")
    ...
    function parseUsage() {
        ...
        try {
            ...
            console.warn("Claude Usage returned invalid data:", error)
        }
    }
    ...
    compactRepresentation: Item {
        ...
        Canvas {
            ...
            onPaint: {
                ...
                ring(28, fiveHourRemaining, "#D97757")
                ring(21.5, weeklyRemaining, "#F0B48A")
            }
        }
