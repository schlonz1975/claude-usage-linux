...
from claude_usage.service import UsageService
from claude_usage.usage import parse_limits
...
class ServiceSerializationTests(unittest.TestCase):
    def test_snapshot_is_serialized_for_qml(self) -> None:
        ...
        with patch("claude_usage.service.time.time", return_value=1234):
        ...
        self.assertEqual(payload["windows"][0]["heading"], "Claude · Pro · Weekly limit")
